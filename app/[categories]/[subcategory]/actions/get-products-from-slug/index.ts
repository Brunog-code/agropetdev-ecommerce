...
import {
  getProductsFromSlugSchema,
  TgetProductsFromSlugSchema,
} from "./schema";
...
export async function getProductsFromSlug({
  slugCategory,
  slugSubcategory,
}: TgetProductsFromSlugSchema) {
  try {
    getProductsFromSlugSchema.parse({ slugCategory, slugSubcategory });
