...
export function Header() {
  return (
    <header className="w-full bg-[#3A7D44]">
      {/* parte superior */}
      <div className="w-full bg-orange-400/90 h-8 flex justify-center sm:justify-around items-center text-white">
        <div className="w-full sm:max-w-1/3 flex justify-center">
          <PromocoesCarousel />
        </div>
      ...
      {/* parte inferior */}
      <div className="flex flex-col sm:flex-row  max-w-7xl mx-auto justify-around items-center p-2">
        <div>
          <Link href="/">
        ...
        <div className="flex gap-6 items-center w-full sm:w-1/2 mt-4">
          <input
            type="text"
